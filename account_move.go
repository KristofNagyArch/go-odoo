...
type AccountMove struct {
	...
	DebitNoteCount                        *Int        `xmlrpc:"debit_note_count,omitempty"`
	DebitNoteIds                          *Relation   `xmlrpc:"debit_note_ids,omitempty"`
	DebitOriginId                         *Many2One   `xmlrpc:"debit_origin_id,omitempty"`
	...
	L10NHuEdiAttachment                   *String     `xmlrpc:"l10n_hu_edi_attachment,omitempty"`
	L10NHuEdiAttachmentFilename           *String     `xmlrpc:"l10n_hu_edi_attachment_filename,omitempty"`
	L10NHuEdiBatchUploadIndex             *Int        `xmlrpc:"l10n_hu_edi_batch_upload_index,omitempty"`
	L10NHuEdiMessageHtml                  *String     `xmlrpc:"l10n_hu_edi_message_html,omitempty"`
	L10NHuEdiMessages                     interface{} `xmlrpc:"l10n_hu_edi_messages,omitempty"`
	L10NHuEdiSendTime                     *Time       `xmlrpc:"l10n_hu_edi_send_time,omitempty"`
	L10NHuEdiState                        *Selection  `xmlrpc:"l10n_hu_edi_state,omitempty"`
	L10NHuEdiTransactionCode              *String     `xmlrpc:"l10n_hu_edi_transaction_code,omitempty"`
	L10NHuInvoiceChainIndex               *Int        `xmlrpc:"l10n_hu_invoice_chain_index,omitempty"`
	L10NHuPaymentMode                     *Selection  `xmlrpc:"l10n_hu_payment_mode,omitempty"`
